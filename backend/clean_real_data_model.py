#!/usr/bin/env python3
"""
Real Data PyTorch Phishing Detection Model - Clean Version
==========================================================

Using real NCIIPC dataset without Unicode characters
"""
...
class CleanRealDataPhishingDetector:
    """Clean phishing detector using real NCIIPC dataset."""
    ...
    def load_cse_whitelist(self):
        ...
        try:
            ...
            print(f"Could not load CSE whitelist: {e}")
            self.cse_data = {}
            self.legitimate_domains = []
            self.legitimate_keywords = []
            self.sectors = set()
    ...
    def extract_51_features(self, domains):
        ...
        print(f"\nExtracting 51 Comprehensive Features from Real Data...")
        ...
        if len(self.feature_names) != 51:
            print(f"Expected 51 features, got {len(self.feature_names)}")
    ...
    def save_model(self, filepath='clean_real_data_pytorch_model.pkl'):
        ...
        model_data = {
            ...
            'model_type': 'clean_real_data_pytorch_51_features',
            'device': str(self.device),
            'timestamp': datetime.now().isoformat()
        }
        
        joblib.dump(model_data, filepath)
        torch.save(self.model.state_dict(), 'clean_real_data_pytorch_weights.pth')
